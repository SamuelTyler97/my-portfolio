    ...
    return (
        ...
        <div className="json-container container" id="about">
            ...
            <span className="vs-yellow">{props.leftBrace} {props.rightBrace} AboutMe.json</span>
                ...
                <a href="mailto: stsoronen2197@gmail.com" className="link-border"><span className="vs-orange">"stsoronen@my.waketech.edu"</span></a>,
                </li>
                <br />

                <li class='double-pad'>
                <img src={linkedin} className="linkedin" alt="the official linkedin logo"></img>
                <a href="https://www.linkedin.com/in/samuelsoronen/" className="link-border"><span className="vs-orange">"Find me on LinkedIn"</span></a>,
                </li>
                <br />

                <li class='double-pad'>
                <img src={github} className="linkedin" alt="the official linkedin logo"></img>
                <a href="https://github.com/SamuelTyler97/portfolio" className="link-border"><span className="vs-orange">"Check out my Github"</span></a>
                </li>
                ...
                <div className="col-lg-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <h5 className="card-title">NC County Website Re-design</h5>
                            <p className="card-text">A fully responsive redesign of a North Carolina county website, incorporating Bootstrap, 
                                and modern CSS techniques. This redesign features a modern look and feel as well as greatly improved UI/UX. The stack for this 
                                project includes HTML5, CSS3, and Bootstrap. </p>
